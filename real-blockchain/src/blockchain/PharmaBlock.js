...
class PharmaBlock {
    ...
    updateEnvironmentalData(temperature, humidity) {
        ...
        const tempViolation = this.checkTemperatureViolation(temperature, previousTemp);
        const humidityViolation = this.checkHumidityViolation(humidity, previousHumidity);
