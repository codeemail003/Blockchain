...
class SecurityAndCompliance extends EventEmitter {
  ...
  async setupRBAC() {
    ...
    const roles = [
      ...
      {
        name: "PHARMACIST",
        permissions: ["VIEW_DRUG_DATA", "CREATE_PRESCRIPTION", "VERIFY_DRUG"],
      },
      {
        name: "MANUFACTURER",
        permissions: ["CREATE_BATCH", "UPDATE_BATCH", "QUALITY_CONTROL"],
      },
      {
        name: "REGULATOR",
        permissions: ["VIEW_ALL_DATA", "CREATE_RECALL", "COMPLIANCE_AUDIT"],
      },
      {
        name: "DISTRIBUTOR",
        permissions: ["VIEW_SHIPMENT", "UPDATE_LOCATION", "VERIFY_RECEIPT"],
      },
    ];
